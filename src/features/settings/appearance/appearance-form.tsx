    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-8'>
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t('settings:appearance.form.font')}</FormLabel>
              ...
              <FormDescription className='font-manrope'>
                {t('settings:appearance.form.fontDesc')}
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t('settings:appearance.form.theme')}</FormLabel>
              <FormDescription>
                {t('settings:appearance.form.themeDesc')}
              </FormDescription>
              <FormMessage />
              <RadioGroup
        ...
        <Button type='submit'>{t('settings:appearance.form.update')}</Button>
      </form>
    </Form>
  )
}
